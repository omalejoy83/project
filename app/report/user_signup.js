...
const GoIcon = (style) => (
  <Icon name='forward-arrow' fill="white"{...style} />
);
      ...
      render(){
        //const {userName,password} = this.props.navigation.state.params
            ...
            >
                ...
                <Thumbnail
                   resizeMethod="resize"
                   large source={require("../../assets/img/logo.jpeg")}
                   style={{marginTop:20}}
                 />
                </View>
        ...
        <Input
                    ...
                    <Button icon={ArrowIcon} style={{backgroundColor:'black', borderRadius:400, borderColor:'black', width:80, alignSelf:'center',marginTop:70, padding:5,height:80}} onPress={()=>this.props.navigation.navigate('Policelogin')}></Button>
                </ScrollView>
                </View>
