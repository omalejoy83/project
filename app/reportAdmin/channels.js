      ...
      render(){
          return(
            ...
            <Header translucent={false}>
                <Left>
                <TouchableNativeFeedback onPress={()=> this._navigate('ProfileAdmin')}>
                <Avatar
                 size="small"
                 resizeMethod="resize"
            ...
            <View style={{flexDirection:'row'}}>
                ...
                <TouchableOpacity onPress={()=> this._navigate('ProfileAdmin')}>
              ...
              <ScrollView>
                    {
                        ...
                        <View style={{ flexDirection:'row'}}>
                            ...
                            <TouchableOpacity onPress={()=> this._navigate('NewScreen',{id:item.id, name: item.name})}>
            ...
            <View style={{flexDirection:'row'}}>
                ...
                <TouchableOpacity onPress={()=> this._navigate('SettingsAdmin')}>  
